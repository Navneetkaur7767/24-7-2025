<?php
/**
* Plugin Name: My-Calender 
* Description: This is the custom calendar Plugin.
* Version: 1.0
* Author: Navneet Kaur
* 
**/

function my_all_shortcode()
{
	$name = "Navneet Kaur";
    return $name;
}
add_shortcode('my_name','my_all_shortcode');
...
function render_my_custom_calendar($attr){
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri() ;?>/assets/css/calendar/style_trial.css">
...
;?>
 ...
 <?php
   wp_enqueue_script('mycustom-script',get_stylesheet_directory_uri().'/assets/js/mycustom-script.js', array(),"",true) ;
...
<table class="table table-bordered w-100 table-fixed head-table">
        ...
        wp_send_json(["success"=>true,"html"=>ob_get_clean(),"month"=>$month,"year"=>$year,"message"=>"done","name"=>date('F Y', $firstDayOfMonth)]);             
